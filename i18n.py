...
from narratives import get_narrative as get_ro_narrative
from i18n_narratives import NARRATIVES_EN
from i18n_questionnaire import POST_SECTIONS_EN
from i18n_questionnaire import PRE_SECTIONS_EN
...
Te rug?m s? confirmi urm?toarele afirma?ii ?nainte de a continua:""",
        ...
        "demographics": {
            ...
            "financial_decisions_title": "6. Experiență cu decizii financiare personale",
            "financial_decisions_prompt": "Cât de des iei decizii legate de buget personal, plăți, economisire sau datorii?",
            "credit_experience_title": "7. Experiență anterioară cu produse de creditare",
            ...
            "financial_familiarity_title": "8. Familiaritate cu conceptele financiare",
            ...
            "living_title": "9. Situație de trai",
            "living_prompt": "Care variantă descrie cel mai bine situația ta actuală de trai?",
            "responsibilities_title": "10. Responsabilități financiare recurente",
            ...
            "country_title": "11. Țara de rezidență",
...
""",
        ...
        "simulation": {
            ...
            "blocked_error": "Cheltuielile lunii depășesc lichiditatea disponibilă și limita de overdraft. Plata creditului nu poate fi executată. Pentru această lună, scorul este 0.",
            ...
            "no_payment_due_notice": "Creditul a fost deja rambursat integral. În această lună nu mai există o plată de credit scadentă. Scorul lunar va fi calculat pe baza lichidității și a utilizării overdraftului.",
            ...
            "feedback_no_payment_due": "Creditul a fost deja rambursat integral. În această lună nu a fost necesară nicio plată la credit. Scorul lunar a fost calculat pe baza lichidității și a utilizării overdraftului.",
            "feedback_invalid": "Suma introdusă depășește lichiditatea disponibilă și limita de overdraft rămasă. Plata nu a fost executată. Pentru această lună, scorul este 0.",
            "feedback_pre_credit": "Cheltuielile lunii depășesc lichiditatea disponibilă și limita de overdraft. Plata creditului nu poate fi executată. Pentru această lună, scorul este 0.",
        },
        "final_score": {
            "title": "Scor final",
...
Please confirm the following statements before continuing:""",
        ...
        "demographics": {
            ...
            "financial_decisions_title": "6. Experience with personal financial decisions",
            "financial_decisions_prompt": "How often do you make decisions related to personal budgeting, payments, saving, or debt?",
            "credit_experience_title": "7. Previous experience with credit products",
            ...
            "financial_familiarity_title": "8. Familiarity with financial concepts",
            ...
            "living_title": "9. Living situation",
            "living_prompt": "Which option best describes your current living situation?",
            "responsibilities_title": "10. Recurring financial responsibilities",
            ...
            "country_title": "11. Country of residence",
...
Participants do not activate the overdraft manually, but their payment decision can lead to its use.""",
        ...
        "simulation": {
            ...
            "blocked_error": "This month’s expenses exceed the available liquidity and the overdraft limit. The loan payment cannot be executed. The score for this month is 0.",
            ...
            "no_payment_due_notice": "The loan has already been fully repaid. No loan payment is due this month. The monthly score will be calculated based on liquidity and overdraft use.",
            ...
            "feedback_no_payment_due": "The loan has already been fully repaid. No loan payment was due this month. The monthly score was calculated based on liquidity and overdraft use.",
            "feedback_invalid": "The amount entered exceeds the available liquidity and the remaining overdraft limit. The payment was not executed. The score for this month is 0.",
            "feedback_pre_credit": "This month’s expenses exceed the available liquidity and the overdraft limit. The loan payment cannot be executed. The score for this month is 0.",
        },
        "final_score": {
            "title": "Final score",
