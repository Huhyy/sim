...
UI_TEXT = {
    "ro": {
        ...
        "admin_page": "Admin",
        "participant_results_page": "Rezultatele participanților",
        ...
        "admin": {
            ...
            "participant_results_title": "Rezultatele participanților",
            "participant_results_note": "Toți identificatorii participanților și rezultatele finale din sesiunile tale.",
            "participant_code_label": "Cod participant",
            "prolific_id_label": "ID Prolific",
            "participant_count_label": "participanți listați",
            "session_code_label": "Sesiune",
            "bonus_label": "Bonus de performanță",
            "payout_label": "Plată (GBP)",
            "no_participant_results": "Nu există încă identificatori de participanți.",
...
procesul decizional în situații economice riscante.""",
            ...
            "gain_frame_notice": "La începutul experimentului, bonusul tău de performanță pornește de la 0 GBP. În funcție de deciziile tale și de scorul comportamental final, bonusul tău de performanță poate ajunge până la 3 GBP.",
            "loss_frame_notice": "La începutul experimentului, bonusul tău provizoriu de performanță pornește de la 3 GBP. În funcție de deciziile tale și de scorul comportamental final, poți pierde până la 3 GBP din bonusul tău de performanță.",
...
""",
        ...
        "done": {
            ...
            "participant_code_label": "Cod participant",
            "bonus_label": "Bonus final obținut",
            "admin_repeat_button": "Rulează din nou simulatorul",
    ...
    "en": {
        ...
        "admin_page": "Admin",
        "participant_results_page": "Participant results",
        ...
        "admin": {
            ...
            "participant_results_title": "Participant results",
            "participant_results_note": "All participant identifiers and their final results across your study sessions.",
            "participant_code_label": "Participant code",
            "prolific_id_label": "Prolific ID",
            "participant_count_label": "participants listed",
            "session_code_label": "Session",
            "bonus_label": "Performance bonus",
            "payout_label": "Payout (GBP)",
            "no_participant_results": "No participant identifiers are available yet.",
...
decision-making in risky economic situations.""",
            ...
            "gain_frame_notice": "At the beginning of the experiment, your performance bonus starts from 0 GBP. Depending on your decisions and final behavioural score your performance bonus may be up to 3 GBP.",
            "loss_frame_notice": "At the beginning of the experiment, your provisional performance bonus starts from 3 GBP. Depending on your decisions and final behavioural score you may lose up to 3 GBP from your performance bonus.",
...
Participants do not activate the overdraft manually, but their payment decision can lead to its use.""",
        ...
        "done": {
            ...
            "bonus_label": "Final bonus obtained",
            "admin_repeat_button": "Run simulator again",
