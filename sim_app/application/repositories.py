...
class ExperimentRepository(Protocol):
    ...
    def account_has_completed(self, account_key: str) -> bool: ...

    def release_account_session(self, account_key: str, session_id: str) -> None: ...

    def find_prolific_session(self, prolific_pid: str, study_id: str) -> dict[str, Any] | None: ...
